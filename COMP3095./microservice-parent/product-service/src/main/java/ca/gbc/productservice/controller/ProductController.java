...
public class ProductController {
    ...
    public List<ProductResponse>getAllProducts(){return productService.getAllProduct();}

    //http://localhost:8080/api/product/66f6ae70519678185fa76e49
    @PutMapping("/{productId}")
    // @ResponseStatus(HttpStatus.NO_CONTENT) Preferable
